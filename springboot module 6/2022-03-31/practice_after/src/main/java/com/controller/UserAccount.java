...
public class UserAccount {
    ...
    @PostMapping("login")
    public String hangleLogin(User user, HttpSession session, @RequestParam(name = "redirect", required = false, defaultValue = "/") String redirect, RedirectAttributes redirectAttributes) {
