...
//        dto.setCategory(this.categoryService.find(productCat)); // set category cho product
...
//        dto.setCategory(categoryService.find(productCat)); // set category cho product lấy từ service lấy từ category id truyền vào
