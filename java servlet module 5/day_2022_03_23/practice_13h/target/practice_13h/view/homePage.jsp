            ...
            <div class="listItems row">
                <c:forEach var="product" items="${latestProduct}">
                    <div class="card col-2 p-1 shadow">
                        <img class="card-img-top" data-id="${product.getId()}"
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="price container row">
                                <div class="price_infor col-10">
                                    <strike class="col-6">${product.getOldPrice()}$</strike>
                                    <b class="text-danger col-6" style="float: right;">${product.getPrice()}$</b>
                                </div>
                                <a href="/practice_13h/my-cart/add?id=${product.getId()}" class="col-2"
                                   data-bs-toggle="tooltip" title="Add to cart!"><i class="fa fa-cart-plus"
...
<%--            <li class="page-item"><a class="page-link" href="?page=${page-1}">Previous</a></li>--%>
            <li class="page-item"><a class="page-link" href="http://localhost:8080/practice_13h/home?pageXX=${page-1}">Previous</a></li>
        </c:if>
        <li class="page-item active"><a class="page-link" href="#">${page}</a></li>
<%--        <li class="page-item"><a class="page-link" href="?page=${page+1}">Next</a></li>--%>
        <li class="page-item"><a class="page-link" href="http://localhost:8080/practice_13h/home?pageXX=${page+1}">Next</a></li>
